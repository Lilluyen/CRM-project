                    ...
                    <div class="cf__fields">
                        ...
                        <div class="cf__subgroup">
                            ...
                            <div class="cf__inline-grid">
                                ...
                                <div class="cf__field${not empty e ? ' cf__field--error' : ''}">
                                    ...
                                    <input class="cf__input" type="number" name="height"
                                           value="${v_height}" placeholder="170">
                            ...
                            <div class="cf__field">
                                ...
                                <select class="cf__input" name="preferred_size">
                                    <option value="S"  ${v_preferredSize == 'S'  ? 'selected' : ''}>S</option>
                                    <option value="M"  ${v_preferredSize == 'M' or empty v_preferredSize ? 'selected' : ''}>
                                        M
                                    </option>
                                    <option value="L"  ${v_preferredSize == 'L'  ? 'selected' : ''}>L</option>
                                    <option value="XL" ${v_preferredSize == 'XL' ? 'selected' : ''}>XL</option>
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="cf__measure-grid">
                                ...
                                <div class="cf__measure-tile cf__field${not empty e ? ' cf__field--error' : ''}">
                                    ...
                                    <input class="cf__input" type="number" step="0.1" name="waist"
                                           value="${v_waist}" placeholder="75.0">
                                    <span class="cf__unit">cm</span>
                                    <c:if test="${not empty e}"><span class="cf__err-msg"><svg viewBox="0 0 24 24"><circle
                                            cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12"
                                                                                                                y1="16"
                                ...
                                <div class="cf__measure-tile cf__field${not empty e ? ' cf__field--error' : ''}">
                                    ...
                                    <input class="cf__input" type="number" step="0.1" name="shoulder"
                                           value="${v_shoulder}" placeholder="40.0">
                                    <span class="cf__unit">cm</span>
                                    <c:if test="${not empty e}"><span class="cf__err-msg"><svg viewBox="0 0 24 24"><circle
                                            cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12"
                                                                                                                y1="16"
                        ...
                        <div class="cf__field">
                            ...
                            <select name="bodyShape" class="cf__input">
                                <option value="HOURGLASS"         ${v_bodyShape == 'HOURGLASS'         ? 'selected' : ''}>
                                    ⧖ Hourglass
                                </option>
                                <option value="PEAR"              ${v_bodyShape == 'PEAR'              ? 'selected' : ''}>
                                    🍐 Pear
                                </option>
                                <option value="APPLE"             ${v_bodyShape == 'APPLE'             ? 'selected' : ''}>
                                    🍎 Apple
                                </option>
                                <option value="RECTANGLE"         ${v_bodyShape == 'RECTANGLE'         ? 'selected' : ''}>
                                    ▭ Rectangle
                                </option>
                                <option value="INVERTED TRIANGLE" ${v_bodyShape == 'INVERTED TRIANGLE' ? 'selected' : ''}>
                                    ▽ Inverted Triangle
                                </option>
                                <option value="SLENDER"           ${v_bodyShape == 'SLENDER'           ? 'selected' : ''}>
                                    | Slender
                                </option>
                            </select>
                        </div>
