<%@ page contentType="text/html;charset=UTF-8" language="java" %>
  <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
    <%@ taglib uri="http://java.sun.com/jsp/jstl/functions" prefix="fn" %>
      <%@ page isELIgnored="false" %> <%-- Xác định role prefix dựa trên role của user --%>
              ...
              <div id="sidebar-menu" class="sidebar-menu">
                <ul>
                  ...
                  <li class="submenu">
                    ...
                    <ul style="${fn:startsWith(page, 'campaign-') ? 'display:block;' : ''}">
                      <li>
                      ...
                      <li>
                        <a class="${page eq 'campaign-form' ? 'active' : ''}"
                          href="${pageContext.request.contextPath}/marketing/campaign/form">
                          Add New Campaign
                        </a>
                      </li>
                      <li>
                        <a class="${page eq 'campaign-detail' ? 'active' : ''}"
                          href="${pageContext.request.contextPath}/marketing/campaign">
                          Campaign Update
                        </a>
                      </li>
                  ...
                  <li class="submenu">
                    ...
                    <ul style="${fn:startsWith(page, 'lead-') ? 'display:block;' : ''}">
                      <li>
                        <a class="${page eq 'lead-list' ? 'active' : ''}"
                          href="${pageContext.request.contextPath}/marketing/leads">
                          Lead List
                        </a>
                      </li>
                      <li>
                        <a class="${page eq 'lead-form' ? 'active' : ''}"
                          href="${pageContext.request.contextPath}/marketing/leads/form">
                          Add New Lead
                        </a>
                      </li>
                      <li>
                        <a class="${page eq 'lead-detail' ? 'active' : ''}"
                          href="${pageContext.request.contextPath}/marketing/leads">
                          Update Lead
                        </a>
                      </li>
                      <li>
                        <a class="${page eq 'lead-import' ? 'active' : ''}"
                  ...
                  <li class="submenu">
                    ...
                    <ul
                      ...
                      <li>
                        <a class="${fn:startsWith(page, 'category-') ? 'active' : ''}"
                          href="${pageContext.request.contextPath}/sale/category/list">Category</a>
                      </li>
                      <li>
                        <a class="${fn:startsWith(page, 'product-') ? 'active' : ''}"
                          href="${pageContext.request.contextPath}/sale/product/list">Product</a>
                      </li>
                      <li>
                        <a class="${fn:startsWith(page, 'deal-') ? 'active' : ''}"
                          href="${pageContext.request.contextPath}/deal/list">Deals</a>
                      </li>
                      <li>
                        <a class="${page eq 'sales-funnel' ? 'active' : ''}"
                          href="${pageContext.request.contextPath}/funnel">Sales Funnel</a>
                      </li>
                      <li>
                        <a class="${page eq 'revenue-forecast' ? 'active' : ''}"
                          href="${pageContext.request.contextPath}/forecast">Revenue Forecast</a>
                      </li>
                    </ul>
                  </li>
                  ...
                  <li class="submenu">
                    ...
                    <ul style="${page eq 'customer-list' ? 'display:block;' : ''}">
                      ...
                      <li>
                        <a class="${page eq 'merge-customers' ? 'active' : ''}"
                  ...
                  <li class="submenu">
                    ...
                    <ul style="${fn:startsWith(page, 'notification-') ? 'display:block;' : ''}">
                      <li>
                        <a class="${page eq 'notification-list' ? 'active' : ''}"
                      ...
                      <li>
                        <a class="${page eq 'notification-rules' ? 'active' : ''}"
                  ...
                  <!-- REPORT -->
                  <c:if test="${fn:toUpperCase(userRole) eq 'ADMIN' || fn:toUpperCase(userRole) eq 'MARKETING'}">
                    <li>
                  ...
                  <li class="submenu">
                    ...
                    <ul>
                      ...
                      <li>
                        <a href="${pageContext.request.contextPath}/monitor">Monitoring</a>
                      </li>
                      <li>
