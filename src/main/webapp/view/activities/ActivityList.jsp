...
<body class="bg-background-light dark:bg-background-dark font-display">
    ...
    <div class="max-w-7xl mx-auto px-4 py-8">
        ...
        <div class="flex justify-between items-center mb-8">
            ...
            <a href="${pageContext.request.contextPath}/activities/create" class="flex items-center gap-2 bg-primary text-white px-4 py-2 rounded-lg hover:bg-primary/90 transition">
            ...
            <c:choose>
                            ...
                            <tbody class="divide-y dark:divide-slate-700">
                                <c:forEach var="activity" items="${activities}">
                                    <tr class="hover:bg-slate-50 dark:hover:bg-slate-800/50 transition">
                                        ...
                                        <td class="px-6 py-4 text-sm dark:text-slate-300">
                                            <div class="text-slate-600 dark:text-slate-400">${activity.relatedName}</div>
                                            <div class="text-xs text-slate-500">${activity.relatedType} #${activity.relatedId}</div>
                                        </td>
                                        <td class="px-6 py-4 text-sm dark:text-slate-300">
                                            <c:choose>
                                        ...
                                        <td class="px-6 py-4 text-sm">
                                            <div class="flex gap-2">
                                                ...
                                                <a href="${pageContext.request.contextPath}/activities/update?id=${activity.activityId}&action=edit" 
                                                   class="text-primary hover:text-primary/80 transition flex items-center gap-1">
                ...
                <c:otherwise>
                    <div class="p-8 text-center">
                        ...
                        <a href="${pageContext.request.contextPath}/activities/create" class="inline-flex items-center gap-2 bg-primary text-white px-4 py-2 rounded-lg hover:bg-primary/90 transition">
                            <span class="material-symbols-outlined">add</span>
                            Create Activity
                        </a>
                    </div>
