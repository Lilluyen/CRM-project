    ...
    <div class="max-w-md mx-auto px-4">
        ...
        <div class="bg-white dark:bg-slate-900 rounded-xl shadow border dark:border-slate-800 p-8 text-center">
            ...
            <div class="space-y-3 mt-6">
                <a href="/" class="block w-full h-12 rounded-lg bg-primary text-white font-medium hover:bg-primary/90 transition flex items-center justify-center gap-2">
                    <span class="material-symbols-outlined">home</span>
                    Go to Dashboard
                </a>
                <a href="/activities/list" class="block w-full h-12 rounded-lg bg-slate-200 dark:bg-slate-800 text-slate-900 dark:text-slate-100 font-medium hover:bg-slate-300 dark:hover:bg-slate-700 transition flex items-center justify-center gap-2">
