        ...
        <div class="p-8">
            ...
            <form action="login" method="post" class="space-y-4">
                ...
                <a href="${pageContext.request.contextPath}/customer/request-otp"
                   class="w-full h-12 flex items-center justify-center border border-primary text-primary rounded-lg font-semibold hover:bg-primary/10 transition">
