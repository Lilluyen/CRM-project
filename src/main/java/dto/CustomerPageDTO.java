...
public class CustomerPageDTO {
    private final List<CustomerSegmentListDTO> data;
    ...
    public CustomerPageDTO(List<CustomerSegmentListDTO> data, int totalRecords, int totalPages, int currentPage, int pageSize, String sessionId, String nextAnchorRfm, int nextAnchorId) {
        this.data = data;
    ...
    public List<CustomerSegmentListDTO> getData() {
        return data;
    }
